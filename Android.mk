...
include $(CLEAR_VARS)
LOCAL_MODULE := fdroid-debug-repo
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/org.fdroid.fdroid.debug
LOCAL_MODULE_STEM := additional_repos.xml
LOCAL_SRC_FILES := additional_repos.xml
LOCAL_PRODUCT_MODULE := true
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := fdroid-basic-debug-repo
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_PATH := $(TARGET_OUT_PRODUCT_ETC)/org.fdroid.basic.debug
LOCAL_MODULE_STEM := additional_repos.xml
LOCAL_SRC_FILES := additional_repos.xml
LOCAL_PRODUCT_MODULE := true
include $(BUILD_PREBUILT)
...
LOCAL_SRC_FILES := repo/$(LOCAL_MODULE).apk
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_PRODUCT)/fdroid/repo
LOCAL_CERTIFICATE := $(LOCAL_PATH)/../microg/certs/microg
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
LOCAL_NO_STANDARD_LIBRARIES := true
LOCAL_ENFORCE_USES_LIBRARIES := false
...
include $(CLEAR_VARS)
LOCAL_MODULE := GCamPhotosPreview
LOCAL_SRC_FILES := repo/$(LOCAL_MODULE).apk
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_PRODUCT)/fdroid/repo
LOCAL_CERTIFICATE := PRESIGNED
LOCAL_MODULE_CLASS := APPS
